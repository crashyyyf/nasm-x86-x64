...
The author assumes **no responsibility** for how the code in this repository is used.
Use this material only on software and systems you own or have explicit permission to test.
